...
public class Spy
{
    ...
    public string CollectGettersAndSetters(string className)
    {
        ...
        IEnumerable<MethodInfo> methods = classInfo.GetMethods(BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public);
        ...
        foreach (MethodInfo method in methods)
        {
            if (method.Name.StartsWith("set"))
            {
                ...
                sb.AppendLine($"{method.Name} will set field of {parameters.First().ParameterType}");
            }
        }
